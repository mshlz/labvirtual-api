...
export class AuthMiddleware implements ExpressMiddlewareInterface {
    private skipRoutes = ['/health', '/auth/login', '/auth/register', '/auth/confirm-account', '/auth/forgot-password', '/auth/check-token', '/auth/reset-password', '/disciplines/with-subjects', '/pages/router-info']
